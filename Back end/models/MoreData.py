from controller.Sql_Insert import insert_more_data
from controller.Sql_Select import get_only_more_data
from controller.Sql_Update import update_more_data
